package org.sevenchan.dongs.bodyparts 
{
	...
	public class Build
	{
		...
		public static const AVG:Build = new Build(1, 1,"of average weight and build.");
		public static const HIDEOUS:Build = new Build(2.5, -0.5, "hideously fat;  You can practically <i>smell</i> the decaying flesh between the rolls.");
